...
>>>>>>> 5fdfec23059b1cb44d00ec7886327299eaaba310
...
<h1>Alumnos</h1>
    ...
    <!-- </div>s -->
        ...
        <?php
            ...
            $stmt_total = $conn->prepare("SELECT COUNT(*) FROM alumnos WHERE `activo`='0' AND (alumnos.nombre LIKE :nombre 
            ...
            $sql="SELECT alumnos.*, alumnos.nombre, alumnos.apellido, alumnos.dni, alumnos.telefono FROM alumnos
                WHERE `activo`='0' AND (alumnos.nombre LIKE :nombre 
                OR alumnos.apellido LIKE :apellido 
                OR alumnos.dni LIKE :dni
