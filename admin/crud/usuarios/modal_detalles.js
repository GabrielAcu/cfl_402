    ...
    btn.addEventListener("click", function () {
        ...
        fetch(`cargar_datos.php?id=${id}`)
            ...
            .then(data => {
                ...
                const a = data.usuario;   // ← IMPORTANTE
                    ...
                    <form action="procesar_modificacion.php" method="POST">
                        ...
                        <div class="fila">
                            ...
                            <div class="campo">
                                ...
                                <input class="input-modify" type="password" name="contrasenia" id="contrasena-usuario" value="${a.contrasenia}" placeholder="Apellido" required>
                            </div>

                            <div class="campo">
                                <label for="rol-usuario"> Rol De Usuario: </label>
                                <select name="rol" id="rol-usuario" value=${a.rol} required>
